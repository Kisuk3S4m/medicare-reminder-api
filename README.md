...
## Disclaimer  
This RESTful API is developed **ONLY** for personal and educational purposes.  
It is not intended for real-life medical use, professional healthcare services, or managing actual patient data.  
The API should not be used in production environments or for any commercial purposes,  
and the developers assume no responsibility for any misuse of this software.
